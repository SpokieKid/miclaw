...
EinClaw frontend — Vite + React 19 + TypeScript + TailwindCSS v4 + shadcn/ui.
...
public/product-white.png: White EinClaw device product photo (hero image)
public/product-device.png: Dark EinClaw device product photo (unused)
